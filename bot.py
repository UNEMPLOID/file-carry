    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/+wicp4j6rmn45MTI9"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/FALCON_SECURITY")
                    ],
                    [
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://github.com/Unemploid/File-Carry")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/+wicp4j6rmn45MTI9).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/+wicp4j6rmn45MTI9).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
